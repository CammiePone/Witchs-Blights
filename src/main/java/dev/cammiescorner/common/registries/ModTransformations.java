...
public class ModTransformations {
	...
	public static final RegistrySupplier<Transformation> VAMPIRE = TRANSFORMATIONS.register("vampire", () -> new Transformation(ModPotions.SANGUINE_BLIGHT.holder(), ModEntities.VAMPIRE_BEAST.get(), ModTags.VAMPIRE_BEAST_TARGETS, WitchsBlightsConfig.baseVampireUrgingTicks, WitchsBlightsConfig.baseVampireStageUrgingModifier, WitchsBlightsConfig.baseVampireBabyUrgingModifier));
}
